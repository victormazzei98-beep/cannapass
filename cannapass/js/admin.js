...
const Admin = (() => {
  ...
  // BRAZIL_CITIES e UF_NAMES vêm do config.js — fonte única compartilhada com o
  // portal do Paciente, que usa exatamente as mesmas cidades nos seletores de viagem.
